...
namespace dpl
{
	...
	/*
		...
		- Linking the buffer that stores a component type to the StreamController object is possible if the component type satisfies the requirements for streamable data.
